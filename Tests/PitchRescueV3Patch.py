...
# The workflow already invokes this V3 gate, so chain V4 here without adding a
# second audio/source path or changing the frozen renderer workflow contract.
runpy.run_path('Tests/PitchRescueV4Patch.py', run_name='__main__')
print('Pitch rescue V3 invariant verified; V4 phonetic-onset challenger guard applied')
