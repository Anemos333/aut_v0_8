...
print('Pitch rescue V3/V4 verified; sound=correction authority, rap presence, zero-path, zero-consensus correction and real consensus metering guards applied')
