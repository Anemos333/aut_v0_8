...
int main()
{
    ...
    {
        return tracker.measureCoordinate(
    ...
    tracker.fullRateCandidate_.candidate = tracker.measureCoordinate(
    ...
    tracker.halfRateCandidate_.candidate = tracker.measureCoordinate(
    ...
    tracker.quarterRateCandidate_.candidate = tracker.measureCoordinate(
    ...
    tracker.eighthRateCandidate_.candidate = tracker.measureCoordinate(
